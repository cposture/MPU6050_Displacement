...
*	description....:	如果加速度的值为0的次数超过设置值，则将速度的值置0
*	param..........:	accel_n	:加速度值指针
						vel[in,changed]	:速度值指针,vel[1][0-2]为当前速度，vel[0][0-2]为上一速度
*	return.........:
*	precondition...:
*	postcondition..:
*/
...
*	Name...........:	position
*	description....:	位移计算
*	param..........:	accel_n	:地理坐标系的加速度值指针，accel_n[1][0-2]为当前加速度，accel_n[0][0-2]为前一加速度
						vel[in,out]		:速度值指针，vel[1][0-2]为当前速度，vel[0][0-2]为上一速度
						displayment[out]	:位移指针，displayment[1][0-2]为当前位移，displayment[0][0-2]为上一位移
*	return.........:
*	precondition...:
*	postcondition..:
*/
